...
x1 = area_calculator(samples[:, 0], results, plot=False, step_size=100)
x2 = area_calculator(samples[:, 1], results, plot=False, step_size=100)
x3 = area_calculator(samples[:, 2], results, plot=False, step_size=100)
